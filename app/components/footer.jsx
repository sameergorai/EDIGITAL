...
const Footer = () => {
  ...
  const companyLinks = [
    ...
    { name: 'Career', href: '/career', icon: HiAcademicCap },
    { name: 'Terms & Conditions', href: '/terms', icon: HiShieldCheck }
  ];
  ...
  const socialLinks = [
    ...
    { icon: FaWhatsapp, href: 'https://wa.me/919934141233', label: 'WhatsApp', color: 'hover:bg-green-500' }
  ];
